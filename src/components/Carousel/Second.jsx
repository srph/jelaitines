  ...
  render: function () {
    return (
      <div className="u-uppercase u-text-center">
        ...
        <div ref={'_2'} style={HideStyle}> <h1 className="highlight-type u-nocase"> Smile </h1> </div>
        <div ref={'_3'} style={HideStyle}> <h5> <span className="l-type">Stole My Heart</span> </h5> </div>
      </div>
    );
  },
